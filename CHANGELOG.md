...
- **i18n: EditorB — chrome** (ítem #2): pasos (ACCIÓN/CONFIGURAR/ESTILO), título, vista previa, navegación (atrás/cancelar/siguiente/guardar) y contador de paso, traducidos ES/EN. (Los campos de configuración por acción quedan para ítems #3-#5.)
