...
export const ACTION_TYPES: { type: ActionType; label: string; Icon: React.ComponentType<VDIconProps>; desc: string }[] = [
  ...
  { type: 'adjust',           label: 'act.adjust.label',           Icon: IconBrightness,      desc: 'act.adjust.desc' },
...
export const PRESETS: ButtonPreset[] = [
  // APPS
  { category: 'APPS', label: 'Spotify', icon: 'AUDIO_WAVE', bgColor: '#1a3320', fgColor: '#1DB954', action: { type: 'app', appPath: 'spotify' } },
  { category: 'APPS', label: 'Discord', icon: 'MIC', bgColor: '#1e1f40', fgColor: '#7289da', action: { type: 'app', appPath: '%LOCALAPPDATA%\\Discord\\Update.exe --processStart Discord.exe' } },
  { category: 'APPS', label: 'VS Code', icon: 'CODE', bgColor: '#00264d', fgColor: '#4fc3f7', action: { type: 'app', appPath: 'code' } },
  { category: 'APPS', label: 'Chrome', icon: 'WEB', bgColor: '#1a2a4a', fgColor: '#4a90d9', action: { type: 'app', appPath: 'chrome' } },
  { category: 'APPS', label: 'OBS Studio', icon: 'PLAY', bgColor: '#1a1424', fgColor: '#a78bfa', action: { type: 'app', appPath: 'obs64' } },
  { category: 'APPS', label: 'Steam', icon: 'PLAY', bgColor: '#0d1b2a', fgColor: '#66c0f4', action: { type: 'app', appPath: 'steam' } },
  { category: 'APPS', label: 'Explorador', icon: 'FOLDER', action: { type: 'app', appPath: 'explorer.exe' } },
  { category: 'APPS', label: 'Notepad', icon: 'EDIT', action: { type: 'app', appPath: 'notepad.exe' } },
  ...
  { category: 'SISTEMA', label: 'Screenshot', icon: 'FULLSCREEN', action: { type: 'hotkey', hotkey: 'PrintScreen' } },
  { category: 'SISTEMA', label: 'Hibernar', icon: 'CLOCK', bgColor: '#0a0a1a', fgColor: '#6688cc', action: { type: 'script', script: 'shutdown /h', scriptShell: 'cmd' } },
  { category: 'SISTEMA', label: 'Apagar (30s)', icon: 'BOLT', bgColor: '#1a0808', fgColor: '#d95f5f', action: { type: 'script', script: 'shutdown /s /t 30', scriptShell: 'cmd' } },
  { category: 'SISTEMA', label: 'Reiniciar', icon: 'DOTS', bgColor: '#0a1a0a', fgColor: '#4caf7d', action: { type: 'script', script: 'shutdown /r /t 30', scriptShell: 'cmd' } },
  { category: 'SISTEMA', label: 'Brillo 30%', icon: 'WEATHER_SUN', action: { type: 'brightness', brightnessLevel: 30 } },
  { category: 'SISTEMA', label: 'Brillo +', icon: 'ARROW_UP', action: { type: 'adjust', adjustTarget: 'brightness', adjustDelta: 10 } },
  { category: 'SISTEMA', label: 'Brillo -', icon: 'ARROW_DOWN', action: { type: 'adjust', adjustTarget: 'brightness', adjustDelta: -10 } },
  { category: 'SISTEMA', label: 'Volumen +', icon: 'ARROW_UP', action: { type: 'adjust', adjustTarget: 'volume', adjustDelta: 10 } },
  { category: 'SISTEMA', label: 'Volumen -', icon: 'ARROW_DOWN', action: { type: 'adjust', adjustTarget: 'volume', adjustDelta: -10 } },
  ...
  { category: 'CREATIVO', label: 'PR Cortar', icon: 'SCISSORS', bgColor: '#0a1a0a', fgColor: '#9999ff', action: { type: 'hotkey', hotkey: 'Ctrl+K' } },
