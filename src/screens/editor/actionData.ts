...
export const PRESETS: ButtonPreset[] = [
  ...
  { category: 'SISTEMA', label: 'Brillo +', icon: '▲', action: { type: 'adjust', adjustTarget: 'brightness', adjustDelta: 10 } },
  { category: 'SISTEMA', label: 'Brillo -', icon: '▼', action: { type: 'adjust', adjustTarget: 'brightness', adjustDelta: -10 } },
  { category: 'SISTEMA', label: 'Volumen +', icon: '▲', action: { type: 'adjust', adjustTarget: 'volume', adjustDelta: 10 } },
  { category: 'SISTEMA', label: 'Volumen -', icon: '▼', action: { type: 'adjust', adjustTarget: 'volume', adjustDelta: -10 } },
