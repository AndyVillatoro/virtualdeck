...
const ACTION_TYPES: { type: ActionType; label: string; Icon: React.ComponentType<VDIconProps>; desc: string }[] = [
  ...
  // 1.2 — Variables persistentes (interpolables como {nombre} en otras acciones)
...
const FOLDER_PRESETS: Record<string, { label: string; icon: string; bgColor: string; fgColor: string; buttons: FolderButton[] }> = {
  illustrator: {
...
const PRESET_CATEGORIES: ButtonPreset['category'][] = ['APPS', 'WEB', 'MEDIA', 'SISTEMA', 'CREATIVO'];
